...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('public/assets/css/auth.css') }}">
    ...
    <link rel="shortcut icon" href="{{ url('public/assets/images/logo/shotcut.jpg') }}" />
            ...
            <div class="row d-flex">
                <div class="col-lg-6">
                    <div class="card1 pb-5">
                        ...
                        <div class="row px-3 justify-content-center mt-4 mb-5 border-line">
                            <img src="{{ asset('public/assets/images/auth/login_admin.png') }}" class="image2">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
