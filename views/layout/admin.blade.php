...
<head>
    ...
    {{-- <---------------------- ASSET ----------------------> --}}
    <link rel="stylesheet" href="{{ url('public/assets/vendors/summernote/dist/summernote-bs4.css') }}">
    ...
    <link rel="stylesheet" href="{{ url('public/assets/css/counter.css') }}">
    <link rel="stylesheet" href="{{ url('public/assets/modules/dropzone.css') }}">
    <link rel="stylesheet" href="{{ url('public/assets/modules/components.css') }}">
    <link rel="stylesheet" href="{{ url('public/assets2/modules/summernote/summernote-bs4.css') }}">
    <link rel="stylesheet" href="{{ url('public/assets2/modules/codemirror/lib/codemirror.css') }}">
    <link rel="stylesheet" href="{{ url('public/assets2/modules/codemirror/theme/duotone-dark.css') }}">
    <link rel="stylesheet" href="{{ url('public/assets2/modules/jquery-selectric/selectric.css') }}">
    <link rel="shortcut icon" href="{{ url('public/general/assets/images/shortcut.jpg') }}" />
...
<body class="@yield('sidebar')">
    ...
    <script src="{{ url('public/assets/vendors/tinymce/themes/modern/theme.js') }}"></script>
    <script src="{{ url('public/assets/vendors/summernote/dist/summernote-bs4.min.js') }}"></script>
    <script src="{{ url('public/assets/js/data-table.js') }}"></script>
    <script src="{{ url('public/assets/js/wizard.js') }}"></script>
    <script src="{{ url('public/assets/modules/dropzone.min.js') }}"></script>
    <script src="{{ url('public/assets/modules/components-multiple-upload.js') }}"></script>
    <script src="{{ url('public/assets2/modules/nicescroll/jquery.nicescroll.min.js') }}"></script>
    <script src="{{ url('public/assets2/js/stisla.js') }}"></script>
    <script src="{{ url('public/assets2/modules/summernote/summernote-bs4.js') }}"></script>
    <script src="{{ url('public/assets2/modules/codemirror/lib/codemirror.js') }}"></script>
    <script src="{{ url('public/assets2/modules/codemirror/mode/javascript/javascript.js') }}"></script>
    <script src="{{ url('public/assets2/modules/jquery-selectric/jquery.selectric.min.js') }}"></script>
