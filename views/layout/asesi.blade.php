...
<head>
    ...
    <link rel="shortcut icon" href="{{ url('public/general/assets/images/lsp_small.jpg') }}" />
</head>
...
<body class="@yield('sidebar')">
    ...
    <script src="{{ url('public/assets/js/bt-maxLength.js') }}"></script>
    <script src="{{ url('public/assets/js/wizards.js') }}"></script>
    <script src="{{ url('public/assets/js/js-grid.js') }}"></script>
    <script src="{{ url('public/assets/js/db.js') }}"></script>
    <script src="{{ url('public/assets/js/tooltips.js') }}"></script>
    <script src="{{ url('public/assets/js/popover.js') }}"></script>
    <script src="{{ url('public/assets/js/modal-demo.js') }}"></script>
    <script src="{{ url('public/assets/js/alerts.js') }}"></script>
    <script src="{{ url('public/assets/js/avgrund.js') }}"></script>
</body>
