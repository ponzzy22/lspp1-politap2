...
<head>
    ...
    <!-- Bootstrap & CSS Utama -->
    <link href="{{ url('public/general/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
    <link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">

    <!-- Tambahan CSS -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/all.min.css">
    <link rel="stylesheet" href="{{ url('public/general/assets/css/fontawesome.css') }}">
    <link rel="stylesheet" href="{{ url('public/general/assets/css/lsp.css') }}">
    <link rel="stylesheet" href="{{ url('public/general/assets/css/owl.css') }}">
...
<body>
    ...
    <script src="{{ url('public/general/vendor/jquery/jquery.min.js') }}"></script>
    <script src="{{ url('public/general/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>

    <!-- Scrip tambahan -->
    <script src="{{ url('public/general/assets/js/custom.js') }}"></script>
    <script src="{{ url('public/general/assets/js/owl.js') }}"></script>
    <script src="{{ url('public/general/assets/js/slick.js') }}"></script>
    <script src="{{ url('public/general/assets/js/accordions.js') }}"></script>
