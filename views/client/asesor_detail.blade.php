...
@endsection
@section('css')
    <link rel="stylesheet" href="{{ url('public/client/css/Detail-Asesor.css') }}">
@endsection
@section('isi')
    <section style="background-image: url('{{ url('public/images/back/1.jpg') }}')" class="u-clearfix u-image u-section-1"
        ...
        <div class="u-clearfix u-sheet u-sheet-1">
            ...
            <div class="u-container-style u-group u-group-2" data-animation-name="customAnimationIn"
                ...
                <div class="u-container-layout u-container-layout-2">
                    @if ($asesor->image)
                        <img class="u-image u-image-1" src="{{ url("public/$asesor->image") }}" data-image-width="1280"
                            data-image-height="853">
                    @else
                        <img class="u-image u-image-1" src="{{ asset('public/images/logo3/1652248540photo.png') }}" data-image-width="1280"
                            data-image-height="853">
                    @endif
                </div>
            </div>
