...
@endsection
@section('css')
    <link rel="stylesheet" href="{{ url('public/client/Visi.css') }}" media="screen">
@endsection
@section('isi')
    ...
    @foreach ($visi as $asu)
        ...
        <section class="u-clearfix u-grey-10 u-section-5" id="sec-e8fc">
            <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
                <img class="u-image u-image-1" src="{{ url($asu->image) }}" data-image-width="362" data-image-height="220">
