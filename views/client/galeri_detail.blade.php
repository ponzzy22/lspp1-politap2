        ...
        <div style="margin-top: 40px; margin-bottom: 40px" class="portfolio-item row">
            @foreach ($galeri->galeri_fotos as $foto)
                <div class="item selfie col-lg-3 col-md-4 col-6 col-sm">
                    <a href="{{ url($foto->image) }}" class="fancylight popup-btn" data-fancybox-group="light">
                        <img class="img-fluid" src="{{ url($foto->image) }}" alt="">
                    </a>
                </div>
            @endforeach
        </div>
            ...
            <div class="u-gallery-inner u-gallery-inner-1">
                ...
                <div class="u-effect-fade u-effect-hover-zoom u-gallery-item">
                    <div class="u-back-slide" data-image-width="1380" data-image-height="920">
                        <img class="u-back-image u-expanded" src="{{ url($foto->image) }}">
                    </div>
